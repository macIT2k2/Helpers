...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        [Header("Custom_MDA")]
        [SerializeField] bool keepAnchorMinY;
        [SerializeField] bool keepAnchorMaxY;
        [SerializeField] bool keepAnchorMinX;
        [SerializeField] bool keepAnchorMaxX;
        ...
        void ApplySafeArea(Rect r)
        {
            ...
            if (Screen.width > 0 && Screen.height > 0)
            {
                ...
                if(group != null) group.padding.top = 100 + (int)r.y;
        ...
        {
            Debug.LogFormat("Safe area: x={0}, y={1}, w={2}, h={3}, r.pos={4}, r.size={5}, screenWidth={6}, screenHeight={7}",
            LastSafeArea.x, LastSafeArea.y, LastSafeArea.width, LastSafeArea.height, LastSafeArea.position, LastSafeArea.size, Screen.width, Screen.height);
        }
    }
}
